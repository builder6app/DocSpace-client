...
export class DocsController {
  ...
  async getSettings(@Req() req: Request) {
    const token = this.authService.extractTokenFromHeaderOrCookie(req as any);
  ...
  async getSettingsColorTheme() {
    return this.settingsService.getSettingsColorTheme();
  }

  @Get('/capabilities')
  async getCapabilities() {
    return this.settingsService.getCapabilities();
  }

  @Get('/settings/version/build')
  async getSettingsVersionBuild() {
    return this.settingsService.getSettingsVersionBuild();
  }
  ...
  async getSettingsRebrandingAdditional() {
    return {
      response: {
        ...
        videoGuidesUrl:
          'https://helpcenter.onlyoffice.com/{ru|de|fr|es|it}/video.aspx',
        salesEmail: 'sales@onlyoffice.com',
        buyUrl:
          'https://www.onlyoffice.com/post.ashx?type=buydocspaceenterprise',
        licenseAgreementsEnabled: true,
        isDefault: true,
        licenseAgreementsUrl:
          'https://help.onlyoffice.com/Products/Files/doceditor.aspx?fileid=6795868&doc=RG5GaVN6azdUQW5kLzZQNzBXbHZ4Rm9QWVZuNjZKUmgya0prWnpCd2dGcz0_IjY3OTU4Njgi0',
      },
      count: 1,
      links: [
        {
